...
"attribution":"from The American Heritage® Dictionary of the English Language, 4th Edition"}]}
        */
        ...
        try {
            ...
            // Possible parameters are avaiable at OWM's forecast API page, at https://market.mashape.com/montanaflynn/dictionary

            //I don't use header, here is the mistake
            URL url = new URL("https://montanaflynn-dictionary.p.mashape.com/define?word=irony").header("X-Mashape-Key", "j3xDUUtlPBmsh2jTpSk26R6i75F7p1c4r9EjsnqnEs6GGPyV7t");
